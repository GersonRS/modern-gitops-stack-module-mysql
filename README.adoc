...
|[[output_cluster_dns]] <<output_cluster_dns,cluster_dns>> |mysql cluster dns
|[[output_cluster_ip]] <<output_cluster_ip,cluster_ip>> |mysql cluster ip internal
|[[output_external_ip]] <<output_external_ip,external_ip>> |Mysql External IPs
|===
// END_TF_TABLES
====
